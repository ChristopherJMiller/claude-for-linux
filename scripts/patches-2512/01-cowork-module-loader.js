#!/usr/bin/env node
/**
 * Patch 01: Load Linux Cowork Module (for Claude Desktop 1.1.2512)
 *
...
console.log('=== Patch 01: Cowork Module Loader (2512) ===\n');
...
const coworkPatch = `
;(function(){
  // Linux Cowork Implementation (v2 for 1.1.2512)
